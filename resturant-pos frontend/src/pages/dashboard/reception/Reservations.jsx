    ...
    <div className="h-full flex flex-col gap-6">
      ...
      <div className="flex-1 flex gap-6 min-h-0">
        ...
        <div className="hidden 2xl:flex w-[320px] flex-col gap-4 overflow-hidden">
           <div className="card bg-surface border-none shadow-xl shadow-slate-100/50 p-6 rounded-[2.5rem] flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto space-y-6 pr-2 scrollbar-hide">
                 {activityLog.map((log) => (
                   <div key={log.id} className="relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-[2px] before:bg-slate-100 last:before:hidden">
                      <div className={cn("absolute left-[-4px] top-1.5 w-2 h-2 rounded-full", log.type === 'success' ? 'bg-emerald-500' : log.type === 'error' ? 'bg-primary' : 'bg-primary')} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select name="type" className="w-full px-5 py-3.5 bg-slate-50 rounded-2xl text-xs font-bold outline-none border-2 border-transparent focus:border-primary/20 focus:bg-surface transition-all appearance-none">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input name="targetId" required placeholder="e.g. RM-101 or T-01" className="w-full px-5 py-3.5 bg-slate-50 rounded-2xl text-xs font-bold outline-none border-2 border-transparent focus:border-primary/20 focus:bg-surface transition-all" />
                  </div>
                </div>
