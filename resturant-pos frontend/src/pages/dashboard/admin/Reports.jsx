    ...
    <div className="space-y-6 h-full flex flex-col overflow-hidden relative">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 shrink-0 print:hidden px-1">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide -mx-1 px-1">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-3 bg-surface border border-slate-100 rounded-2xl text-[9px] font-black uppercase tracking-widest hover:bg-slate-50 shadow-sm shrink-0 transition-all active:scale-95"
          >
      ...
      <div className="flex-1 overflow-y-auto pb-20 lg:pb-8 pr-1 lg:pr-2 scrollbar-hide space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 pb-10">
           ...
           <div 
             ...
             className="card p-6 lg:p-10 bg-indigo-50 border-primary/10 flex flex-col justify-center rounded-[2rem] lg:rounded-[3rem] shadow-xl group hover:bg-surface cursor-pointer active:scale-[0.98] transition-all"
           >
              <div className="w-10 h-10 lg:w-14 lg:h-14 bg-surface rounded-xl lg:rounded-2xl flex items-center justify-center mb-4 lg:mb-6 shadow-md">
      ...
      {showDateModal && (
        <div className="fixed inset-0 z-[550] flex items-center justify-center p-4 lg:p-6">
           ...
           <div 
             className="relative w-full max-w-[90%] md:max-w-sm bg-surface rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 shadow-2xl overflow-hidden self-center"
           >
                ...
                {['Today', 'This Week', 'This Month', 'Last Month', 'Last 90 Days', 'Financial Year'].map(range => (
                  <button 
                    ...
                    className={cn(
                      ...
                      timeRange === range ? "bg-primary text-white border-primary shadow-xl shadow-primary/20" : "bg-surface border-slate-50 text-slate-400 hover:border-primary/20"
                    )}
                  >
                    {range}
                  </button>
             ...
             <button onClick={() => setShowDateModal(false)} className="mt-6 lg:mt-8 w-full text-[8px] lg:text-[9px] font-black text-slate-300 uppercase tracking-widest hover:text-primary">Cancel</button>
           </div>
        </div>
      )}
