...
const Dashboard = () => {
  ...
  if (dashboardData) {
    if (isChef) {
      ...
      stats = [
        { id: 'revenue', name: 'Total Revenue', value: `₹${(dashboardData.stats?.total_revenue || 0).toLocaleString()}`, icon: TrendingUp, change: 'Live', isUp: true, color: 'bg-primary/10 text-primary' },
