          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
            ...
            <button 
              ...
              className={cn(
                ...
                showFilters ? "bg-primary text-white border-primary shadow-lg shadow-primary/20" : "bg-surface border-slate-50 text-text-secondary hover:border-primary/20"
              )}
            >
              ...
              {['Date', 'Amount', 'Payment', 'Table'].map(f => (
                <button 
                  ...
                  className={cn(
                    ...
                    sortBy === f ? "bg-primary text-white border-primary shadow-lg" : "bg-surface border-slate-200 hover:border-primary/30"
                  )}
                >
                  By {f}
                </button>
        ...
        <div className="px-6 md:px-10 py-6 border-t border-slate-50 flex flex-col md:flex-row items-center justify-between bg-slate-50/30 gap-6 shrink-0 mt-4 md:mt-0">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            ...
            <button 
              ...
              className="flex-1 md:flex-none h-12 md:w-12 bg-surface border-2 border-slate-100 rounded-2xl flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-sm group"
            >
